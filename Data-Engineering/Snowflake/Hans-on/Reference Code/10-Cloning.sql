...
-- This is not mandatory reading, but here's the code we'll run in the "Cloning" video. It may come in handy when you're doing the associated hands-on assignment.
